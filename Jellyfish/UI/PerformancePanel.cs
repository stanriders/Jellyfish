...
public class EnablePerformancePanel() : ConVar<bool>("edt_perfpanel", defaultBind: Keys.M);

public class PerformancePanel : IUiPanel
{
    ...
    {
        if (!ConVarStorage.Get<bool>("edt_perfpanel"))
            return;
