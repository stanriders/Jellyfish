...
namespace Jellyfish.Render.Buffers
{
    public class VertexBuffer
    {
        ...
        public VertexBuffer(Vector3[] vertices, Vector2[] uvs, Vector3[] normals, BufferUsageHint usage = BufferUsageHint.StaticDraw)
        {
        ...
        public void Bind()
        {
            GL.BindBuffer(BufferTarget.ArrayBuffer, handler);
        }
        public void Unload()
        {
